package com.clientdata.governanceservice.producer;
...
public class KafkaPublisher {
    ...
    public KafkaResponseBody publishGoldToPlatinum(GoldProcessedResponseBody goldProcessedResponseBody) {
        KafkaResponseBody kafkaResponseBody = new KafkaResponseBody();
        String topic = "gold-to-platinum-topic";

        try {

            kafkaTemplate.send(topic, goldProcessedResponseBody)
